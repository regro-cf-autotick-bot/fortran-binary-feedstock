...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/fortran-binary-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11716&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/fortran-binary-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `fortran-binary` can be installed with:

```
conda install fortran-binary
```

It is possible to list all of the versions of `fortran-binary` available on your platform with:
